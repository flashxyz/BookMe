...
while ($index < $numberOfRooms) {
    ...
    $roomCell[3] = implode(',', array_keys(unserialize($selectSQL_rooms[$index]->services), 1));
    $roomCell[4] = $selectSQL_rooms[$index]->description;
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="greyGradient">
                ...
                <?php if($userID ==0) : ?>
                    <a href="http://bookme.myweb.jce.ac.il/wp-login.php?redirect_to=http%3A%2F%2Fbookme.myweb.jce.ac.il%2Fwp-admin%2F&reauth=1">לחץ כאן להתחברות</a>
                <?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="optionsContainer">
            ...
            <div class="col-sm-3 col-xs-6 text-right">
                שירותים <br><br>
                <table class="table-sm text-right table-cool" style="margin-bottom: 0px;">
                    <tbody>
                    <tr>
                        <td data-halign="right" class="text-right"> שירות</td>
                        <td data-halign="left">&emsp; סמן &emsp;</td>
                    </tr>
                    </tbody>
                </table>
                    ...
                    <table class="table-cool">
                        ...
                        <tr class="trStart">
                            ...
                            <td class='tdStart'><input id="inputStartTime" type="text" class="time labelForom"
                                                       pattern="[0-9]" maxlength="5" placeholder="##:##"
                                                       data-error="input time as ##:##" onkeydown="return false"
                                                       required/>
                            </td>
                        </tr>
                        <tr class="trStart">
                            <td class='tdStart'><label>שעת סיום: </label></td>
                            <td class='tdStart'><input id="inputEndTime" type="text" class="time labelForom"
                                                       data-toggle="validator" pattern="[0-9]" maxlength="5"
                                                       placeholder="##:##" data-error="input time as ##:##"
                        ...
                        <tr class="trStart">
                            ...
                            <td class='tdStart'><input type="text" class="date start labelForom" id="datePicker"
                                                       data-toggle="validator" pattern="[0-9](/)" maxlength="10"
                                                       placeholder="####/##/##" data-error="input date as ##/##/####"
                                                       onkeydown="return false" required/>
                            </td>
                        </tr>
                        <tr class="trStart">
                            <td class='tdStart'><label>כמות:</label></td>
                            <td class='tdStart'><input id="quantity" type="text" class="time labelForom"
                                                       data-toggle="validator" pattern="[0-9]" maxlength="3" required/>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="editRoomTime">
                                ...
                                <br>
                                <button id="deleteOrderButton" type="button" data-dismiss="modal"
                                        class="btn btn-success">מחיקת חדר
                                </button>
                            </div>
