...
+function (a) {
    ...
    function c(c) {
        return this.each(function () {
            var d = a(this), e = d.data("bs.dropdownhover"), f = d.data();
    ...
    b.TRANSITION_DURATION = 300, b.DELAY = 150, b.TIMEOUT, b.DEFAULTS = {animations: ["fadeInDown", "fadeInRight", "fadeInUp", "fadeInLeft"]}, b.prototype.show = function (c) {
        var d = a(c);
        ...
        if (!d.is(".disabled, :disabled")) {
            var f = d.parent(), g = f.hasClass("open");
            if (!g) {
        ...
        var c = a(window);
        b.css({bottom: "", left: "", top: "", right: ""}).removeClass("dropdownhover-top");
        var d = {top: c.scrollTop(), left: c.scrollLeft()};
        ...
        var g = "", h = b.parents(".dropdown-menu").length;
        ...
        }) : e.top < d.top && b.css({bottom: -(d.top - e.top), top: "auto"}); else {
            var i = b.parent(".dropdown"), j = i.offset();
